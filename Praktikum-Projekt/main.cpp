...
int main()
{
	...
	//Textur
	Texture tiles("planks.png", GL_TEXTURE_2D, 0, GL_RGBA, GL_UNSIGNED_BYTE);
	tiles.texUnit(shaderProgram, "tex0", 0);
	Texture tilesSpecular("planksSpec.png", GL_TEXTURE_2D, 1, GL_RED, GL_UNSIGNED_BYTE);
